...
\restrict xlNKvf0Xc1B9D7an9ypVypIc5cBft4klT1AoNz01en9CZjSMuZvufeQcghXkltP

-- Dumped from database version 18.1
-- Dumped by pg_dump version 18.1

-- Started on 2026-06-14 13:56:56
...
--
-- TOC entry 236 (class 1255 OID 16511)
...
-- Name: invent_vedomost(integer); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.invent_vedomost(IN p_id_kabineta integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
  -- удаление
...
ALTER PROCEDURE public.invent_vedomost(IN p_id_kabineta integer) OWNER TO postgres;

--
-- TOC entry 238 (class 1255 OID 16515)
...
--
-- TOC entry 251 (class 1255 OID 16520)
-- Name: spisanie_oborudovaniya(character varying, text); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.spisanie_oborudovaniya(IN p_unical_nomer character varying, IN p_prichina_spisaniya text)
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_id_tipa INT;
...
ALTER PROCEDURE public.spisanie_oborudovaniya(IN p_unical_nomer character varying, IN p_prichina_spisaniya text) OWNER TO postgres;

--
-- TOC entry 237 (class 1255 OID 16513)
...
--
-- TOC entry 250 (class 1255 OID 16518)
-- Name: zakreplenie_ustroistva(character varying, integer); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.zakreplenie_ustroistva(IN p_unical_nomer character varying, IN p_id_mesta integer)
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_id_tipa INT;
...
ALTER PROCEDURE public.zakreplenie_ustroistva(IN p_unical_nomer character varying, IN p_id_mesta integer) OWNER TO postgres;
...
CREATE TABLE public.users (
    ...
    parol character varying(16) NOT NULL
);
...
--
-- TOC entry 4903 (class 2604 OID 16424)
...
--
-- TOC entry 4904 (class 2604 OID 16432)
...
--
-- TOC entry 4902 (class 2604 OID 16408)
...
--
-- TOC entry 5101 (class 0 OID 16438)
-- Dependencies: 229
...
--
-- TOC entry 5106 (class 0 OID 16470)
-- Dependencies: 234
...
--
-- TOC entry 5100 (class 0 OID 16429)
-- Dependencies: 228
...
--
-- TOC entry 5104 (class 0 OID 16457)
-- Dependencies: 232
...
PC-RS-001	Системный блок	2023	2025-12-16	Не подлежит ремонту.
\.
...
--
-- TOC entry 5107 (class 0 OID 24702)
-- Dependencies: 235
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.users (login, parol) FROM stdin;
masha	123
masha	123
nata	123
\.
...
SELECT pg_catalog.setval('public.peremesheniya_id_peremesheniya_seq', 4, true);
...
--
-- TOC entry 4913 (class 2606 OID 16403)
...
--
-- TOC entry 4933 (class 2606 OID 16479)
...
--
-- TOC entry 4923 (class 2606 OID 16427)
...
--
-- TOC entry 4925 (class 2606 OID 16437)
...
--
-- TOC entry 4921 (class 2606 OID 16415)
...
--
-- TOC entry 4931 (class 2606 OID 16468)
...
--
-- TOC entry 4940 (class 2620 OID 16512)
...
--
-- TOC entry 4939 (class 2620 OID 16514)
...
--
-- TOC entry 4941 (class 2620 OID 16516)
...
--
-- TOC entry 4935 (class 2606 OID 16480)
...
--
-- TOC entry 4936 (class 2606 OID 16490)
...
--
-- TOC entry 5091 (class 3256 OID 16542)
-- Name: rabochie_mesta employee_own_mesta; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY employee_own_mesta ON public.rabochie_mesta FOR SELECT TO employee USING ((id_sotrudnika = ((CURRENT_USER)::character varying)::integer));


--
-- TOC entry 5092 (class 3256 OID 16543)
-- Name: oborudovanie employee_own_oborudovanie; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY employee_own_oborudovanie ON public.oborudovanie FOR SELECT TO employee USING ((id_mesta IN ( SELECT rabochie_mesta.id_mesta
   FROM public.rabochie_mesta
  WHERE (rabochie_mesta.id_sotrudnika = ((CURRENT_USER)::character varying)::integer))));


--
-- TOC entry 5090 (class 0 OID 16438)
-- Dependencies: 229
-- Name: oborudovanie; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.oborudovanie ENABLE ROW LEVEL SECURITY;

--
-- TOC entry 5089 (class 0 OID 16429)
-- Dependencies: 228
-- Name: rabochie_mesta; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.rabochie_mesta ENABLE ROW LEVEL SECURITY;
...
GRANT SELECT ON TABLE public.cabinets TO auditor_equipment;


--
-- TOC entry 5115 (class 0 OID 0)
-- Dependencies: 229
-- Name: TABLE oborudovanie; Type: ACL; Schema: public; Owner: postgres
--

GRANT INSERT,DELETE,UPDATE ON TABLE public.oborudovanie TO it_specialist;
GRANT SELECT ON TABLE public.oborudovanie TO auditor_equipment;
GRANT SELECT ON TABLE public.oborudovanie TO employee;


--
-- TOC entry 5116 (class 0 OID 0)
-- Dependencies: 234
-- Name: TABLE peremesheniya; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.peremesheniya TO auditor_equipment;


--
-- TOC entry 5118 (class 0 OID 0)
-- Dependencies: 226
-- Name: TABLE pol; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.pol TO auditor_equipment;


--
-- TOC entry 5120 (class 0 OID 0)
-- Dependencies: 228
-- Name: TABLE rabochie_mesta; Type: ACL; Schema: public; Owner: postgres
--

GRANT INSERT,DELETE,UPDATE ON TABLE public.rabochie_mesta TO it_specialist;
GRANT SELECT ON TABLE public.rabochie_mesta TO auditor_equipment;
GRANT SELECT ON TABLE public.rabochie_mesta TO employee;
...
GRANT SELECT ON TABLE public.sotrudniki TO auditor_equipment;


--
-- TOC entry 5124 (class 0 OID 0)
-- Dependencies: 232
-- Name: TABLE spisannoe_oborudovanie; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.spisannoe_oborudovanie TO auditor_equipment;


--
-- TOC entry 5125 (class 0 OID 0)
-- Dependencies: 231
-- Name: TABLE tip; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.tip TO auditor_equipment;


-- Completed on 2026-06-14 13:56:56

--
-- PostgreSQL database dump complete
--

\unrestrict xlNKvf0Xc1B9D7an9ypVypIc5cBft4klT1AoNz01en9CZjSMuZvufeQcghXkltP
